...
if (isset($_SESSION['admin'])) {
  ...
  if (isset($_SESSION['admin'])) {
    ...
    $query=mysqli_query($dbc, "SELECT * FROM users WHERE id_user!=$datauser[id_user]");
    $level='admin';
  } 
?>
<!DOCTYPE html>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li class="mm-show">
                            <a href="javascript: void(0);"><i class="feather-copy"></i><span>Artikel</span></a>
                ...
                <div class="navbar-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="header-breadcumb">
                            ...
                            <h2 class="header-title" style="text-transform: uppercase;">Data Alumni</h2>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?php if (isset($_GET['success'])) { ?><div class="alert alert-success alert-dismissible fade show mb-0" role="alert">
                                ...
                                <p>Selamat <b><?php echo $_GET['success']; ?></b> silahkan cek data alumni kembali.</p>
                            ...
                            <div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
                                ...
                                <p>Sebelum memverifikasi alumni silahkan cek terlebih dahulu apakah pengguna yang mendaftar benar-benar alumni dengan cara cek ijazah <a href="">disini</a>. Apabila pendaftar valid alumni silahkan konfirmasi dan apabila tidak valid maka silahkan hapus data pendaftar agar database tidak terlalu terbebani.</p>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <span aria-hidden="true">×</span>
                                </button>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">
                                        Berikut adalah data seluruh alumni baik yang telah verified (terverifikasi) atau unverified <i>(belum terverifikasi)</i>.
                                    </p>
                                    <table id="key-datatable" class="table dt-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/assets/img/profile/<?php echo $data['ijazah']; ?>">Lihat</a></td>
                                            <td>
                                                <?php
                                                if ($data['status']==1) {
                                                    echo "Verified";
                                            ...
                                            <td>
                                              <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">  
                                                <button type="button" class="btn btn-success" onclick="window.location='()confirmation.php?id=<?php echo $data['id_user']; ?>'"><i class="feather-user-check "></i></button>
                                                <button type="button" class="btn btn-danger" onclick="window.location='delete.php?id=<?php echo $data['id_user']; ?>'"><i class="feather-trash"></i>
                                                </button>
                                              </div>
                                            </td>
                                        </tr>
