                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="pages-invoice.html">Data Alumni</a></li>
                            </ul>
                        </li>
                        <?php } ?>
                ...
                <div class="navbar-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="header-breadcumb">
                            ...
                            <h2 class="header-title">BUAT ARTIKEL</h2>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">
                                        Halaman untuk membuata artikel mengenani berita, lowongan pekerjaan dan informasi magang. Alumni dapat membuat sebuah artikel memlalui konfirmasi dan review artikel dari administrator demi mencegah copy right dan sejenisnya.
                                    </p>
                                    <hr>
                                    ...
                                    <form action="()add.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="gambar" class="dropify" data-max-file-size="1M" />
                                        </div>
                                        <div class="form-group">
                                            <label for="content">Konten</label>
                                            <textarea name="content" id="myTextarea" style="z-index: 99999;"></textarea>
                                        </div>
