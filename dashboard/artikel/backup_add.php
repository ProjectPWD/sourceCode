  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        ...
        <div class="card-body">
          <form action="<?php echo $base_url; ?>/dashboard/article/()add.php" method="POST" enctype="multipart/form-data">
            
            <div class="form-group">
              <label for="title">Judul</label>
              <input type="text" name="title" id="title" placeholder="Title Article..." class="form-control">
            </div>
            ...
            <div class="form-group">
              <div class="text-center">
                <button class="btn btn-primary btn-sm" name="tambahartikel" id="tambahartikel">TAMBAH ARTIKEL</button>
