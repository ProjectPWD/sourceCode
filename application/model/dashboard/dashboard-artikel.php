  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        ...
        <div class="card-body">
        	<ul>
        		<li><a href="/dashboard/artikel/data">Data Artikel</a></li>
        		<li><a href="/dashboard/artikel/tambah">Tambah Artikel</a></li>
        		<?php if(isset($_SESSION['admin'])) { ?>
        		<li><a href="/dashboard/artikel/konfirmasi">Konfirmasi Artikel</a></li> 
          		<?php } ?>
        	</ul>
        </div>
      </div>
